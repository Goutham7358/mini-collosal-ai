...
% ======================================================================
\section{Nadhiya R S --- Problem Statement, Strategies \& Summary}
% ======================================================================

\subsection{Title Slide}
\textit{[Title slide displayed. Nadhiya introduces the team.]}

Hi everyone. We are Team Mini Colossal-AI. Our members are Dinesh, Goutham, Meena, and myself, Nadhiya --- all from MTech-AI at IISc. I will start with the problem statement, motivation, and the four parallelism strategies we built, then hand over to Goutham for the hybrid methodology, Meena and Dinesh will walk through the results, and I will wrap up with the summary.
...
There are multiple ways to do that --- Data Parallelism, Tensor Parallelism, Pipeline Parallelism, and ZeRO optimizer sharding. Each has very different communication patterns and memory trade-offs. I will walk through each of them in the next slide.
...
I will now hand over to Goutham who will explain how we composed these into a hybrid system.
...
Thanks Nadhiya. The interesting part is composing these strategies. We wrote a single unified plugin that takes TP size, PP size, and ZeRO stage as arguments. It automatically computes the DP size as world size divided by TP times PP.
